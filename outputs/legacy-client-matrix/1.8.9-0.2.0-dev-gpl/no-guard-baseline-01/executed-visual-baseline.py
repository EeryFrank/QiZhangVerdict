...
resources=h['memory_gate']('vanilla-forge-visual-baseline-01',minimum_gib=3.5)
...
server_dir,entry=h['prepare_server']('vanilla-forge-visual-baseline-01','forge',include_guard=False)
...
try:
    ...
    result['raw_evidence']=[matrix.artifact_record(p) for p in (server_log,client_log,directory/'options-before.txt',directory/'options-after.txt') if p.exists()]
    screenshots=[]
