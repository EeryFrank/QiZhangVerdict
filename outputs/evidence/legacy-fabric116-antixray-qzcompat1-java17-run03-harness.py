...
def stage(args):
    ...
    properties = {
        ...
        "level-name": "world", "level-type": "flat", "generator-settings": json.dumps(generator, separators=(",", ":")),
...
async function main() {
  ...
  assert.deepEqual(generator.settings.layers,[{height:1,block:'minecraft:bedrock'},
    {height:59,block:'minecraft:stone'},{height:1,block:'minecraft:grass_block'}]);
